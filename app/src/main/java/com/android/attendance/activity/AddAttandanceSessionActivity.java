...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] branchString = new String[] { "MCA"};
	private String[] yearString = new String[] {"First","Second","Third"};
	private String[] subjectSEString = new String[] {"Sub1","Sub2"};
	private String[] subjectTEString = new String[] {"Sub3","Sub4"};
	private String[] subjectBEString = new String[] {"Sub5","Sub6"};

	private String[] subjectFinal = new String[] {"Sub1","Sub2","Sub3","Sub4","Sub5","Sub6"};
