	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				attendanceSessionBean.setAttendance_session_department("MCA");
				attendanceSessionBean.setAttendance_session_class("CSE");
				attendanceSessionBean.setAttendance_session_date("08/10/2019");
				...
				facultyBean.setFaculty_address("mys");
				...
				studentBean.setStudent_address("mys");
